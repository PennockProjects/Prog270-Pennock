...
var bucketName = 'prog270.pennockprojects.com';
...
walkDirs('Pennock-Week03-c9io');
walkDirs('Pennock-Week04-Bootstrap');
walkDirs('Pennock-Week04-Git');
walkDirs('Pennock-Week04-MediaQueries');
walkDirs('Pennock-Week05-Bootstrap');
walkDirs('Pennock-Week06-Animation');
walkDirs('Pennock-Week06-VirtualBoxAndroid');
walkDirs('Pennock-Week07-Midterm');
walkDirs('Pennock-Week08-GitPractice');
walkDirs('Week08-LastPass');
walkDirs('Week08-Mongo');
//listBuckets(s3);
